  ...
  return (
    <div className="detail-page">
      ...
      <Card className="detail-card" bordered={false}>
        ...
        <Typography.Text type="secondary">发布于 {new Date(question.created_at).toLocaleString('zh-CN')}</Typography.Text>
        ...
        {question.answers.length ? <Typography.Paragraph>{question.answers.join('\n')}</Typography.Paragraph> : <Typography.Text type="secondary">暂无回答</Typography.Text>}
      </Card>
